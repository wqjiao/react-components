 ...
 * @Last Modified time: 2019-07-16 10:15:19
...
class LocationCascader extends PureComponent {
    ...
    clickFunction = (me, e) => {
        ...
        if (
            matchesSelector(
                ...
                .incoming-widgets-location-cascader-index-cascaderMenus *`
            )
        ) {
            return;
        }
    ...
    handleClick = e => {
        ...
        e.stopPropagation();
        let me = this;
        const {labelText, style} = this.state;
        ...
        me.setState({
            ...
            style: labelText ? style : {
                ...
                top: scrollTop + offset.top + offset.height,
            },
        });
    };
